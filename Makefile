...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Fr. Aug 12 12:01:26 2011
# Project:  QeoDart.pro
# Template: app
...
SOURCES       = cpp/dart.cpp \
		...
		cpp/qtwin.cpp \
		cpp/dialogs.cpp \
		cpp/preferences.cpp moc_dart.cpp \
		moc_io.cpp \
		moc_dialogs.cpp \
		moc_preferences.cpp
OBJECTS       = dart.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.hpp cpp/io.hpp cpp/myLabels.hpp cpp/qtwin.h cpp/dialogs.hpp cpp/preferences.hpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.cpp cpp/io.cpp cpp/main.cpp cpp/qtwin.cpp cpp/dialogs.cpp cpp/preferences.cpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents ui/mainWindow.ui ui/resultWindow.ui ui/preferences.ui .tmp/QeoDart1.0.0/ && (cd `dirname .tmp/QeoDart1.0.0` && $(TAR) QeoDart1.0.0.tar QeoDart1.0.0 && $(COMPRESS) QeoDart1.0.0.tar) && $(MOVE) `dirname .tmp/QeoDart1.0.0`/QeoDart1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QeoDart1.0.0
...
compiler_moc_header_make_all: moc_dart.cpp moc_io.cpp moc_dialogs.cpp moc_preferences.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_dart.cpp moc_io.cpp moc_dialogs.cpp moc_preferences.cpp
