...
# Generated by qmake (2.01a) (Qt 4.7.2) on: So. Sep 18 18:16:37 2011
# Project:  QeoDart.pro
# Template: app
...
SOURCES       = cpp/dart.cpp \
		...
		cpp/preferences.cpp \
		cpp/results.cpp \
		cpp/highscores.cpp moc_dart.cpp \
		moc_io.cpp \
		moc_preferences.cpp \
		moc_results.cpp \
		moc_highscores.cpp \
...
$(TARGET): ui_mainWindow.h ui_resultWindow.h ui_preferences.h ui_highscore.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.hpp cpp/io.hpp cpp/myLabels.hpp cpp/qtwin.h cpp/preferences.hpp cpp/results.hpp cpp/highscores.hpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents icons.qrc .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.cpp cpp/io.cpp cpp/main.cpp cpp/qtwin.cpp cpp/preferences.cpp cpp/results.cpp cpp/highscores.cpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents ui/mainWindow.ui ui/resultWindow.ui ui/preferences.ui ui/highscore.ui .tmp/QeoDart1.0.0/ && (cd `dirname .tmp/QeoDart1.0.0` && $(TAR) QeoDart1.0.0.tar QeoDart1.0.0 && $(COMPRESS) QeoDart1.0.0.tar) && $(MOVE) `dirname .tmp/QeoDart1.0.0`/QeoDart1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QeoDart1.0.0
...
compiler_moc_header_make_all: moc_dart.cpp moc_io.cpp moc_preferences.cpp moc_results.cpp moc_highscores.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_dart.cpp moc_io.cpp moc_preferences.cpp moc_results.cpp moc_highscores.cpp
...
compiler_uic_make_all: ui_mainWindow.h ui_resultWindow.h ui_preferences.h ui_highscore.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainWindow.h ui_resultWindow.h ui_preferences.h ui_highscore.h
