...
# Generated by qmake (2.01a) (Qt 4.8.3) on: Mon Dec 3 17:27:56 2012
# Project:  QeoDart.pro
# Template: app
...
CFLAGS        = -pipe -O2 -Wall -W -D_REENTRANT -Wno-reorder $(DEFINES)
CXXFLAGS      = -pipe -O2 -Wall -W -D_REENTRANT -Wno-reorder $(DEFINES)
...
install_icon256: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/usr/share/icons/hicolor/256x256/apps/ || $(MKDIR) $(INSTALL_ROOT)/usr/share/icons/hicolor/256x256/apps/ 
