...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Mi. Nov 2 18:23:36 2011
# Project:  QeoDart.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.hpp cpp/io.hpp cpp/myLabels.hpp cpp/qtwin.h cpp/preferences.hpp cpp/results.hpp cpp/highscores.hpp cpp/about.hpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents icons.qrc .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.cpp cpp/io.cpp cpp/main.cpp cpp/qtwin.cpp cpp/preferences.cpp cpp/results.cpp cpp/highscores.cpp cpp/about.cpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents ui/mainWindow.ui ui/resultWindow.ui ui/preferences.ui ui/highscore.ui ui/about.ui .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents lang/de.ts lang/la.ts .tmp/QeoDart1.0.0/ && (cd `dirname .tmp/QeoDart1.0.0` && $(TAR) QeoDart1.0.0.tar QeoDart1.0.0 && $(COMPRESS) QeoDart1.0.0.tar) && $(MOVE) `dirname .tmp/QeoDart1.0.0`/QeoDart1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QeoDart1.0.0
