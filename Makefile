...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Mi. Jul 20 07:57:10 2011
# Project:  QeoDart.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.hpp cpp/io.hpp ccp/myLabels.hpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents cpp/dart.cpp cpp/io.cpp cpp/main.cpp .tmp/QeoDart1.0.0/ && $(COPY_FILE) --parents ui/mainWindow.ui .tmp/QeoDart1.0.0/ && (cd `dirname .tmp/QeoDart1.0.0` && $(TAR) QeoDart1.0.0.tar QeoDart1.0.0 && $(COMPRESS) QeoDart1.0.0.tar) && $(MOVE) `dirname .tmp/QeoDart1.0.0`/QeoDart1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QeoDart1.0.0
...
compiler_moc_header_make_all: moc_dart.cpp moc_io.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_dart.cpp moc_io.cpp
